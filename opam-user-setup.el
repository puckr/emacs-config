...
;; ## added by OPAM user-setup for emacs / tuareg ## f91bff7f93d80a4f340bb9f388a61df0 ## you can edit, but keep this line
...
(when (not (member "tuareg" opam-tools-installed))
  (defun opam-tuareg-autoload (fct file doc args)
    (let ((load-path (cons "/home/robgev/.opam/4.05.0/share/emacs/site-lisp" load-path)))
      (load file))
    (apply fct args))
